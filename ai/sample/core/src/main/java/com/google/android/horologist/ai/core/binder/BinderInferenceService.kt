...
class BinderInferenceService(val stub: InferenceServiceGrpcKt.InferenceServiceCoroutineStub) :
    InferenceServiceGrpcKt.InferenceServiceCoroutineImplBase() {
    override suspend fun serviceInfo(request: Empty): ServiceInfo = try {
