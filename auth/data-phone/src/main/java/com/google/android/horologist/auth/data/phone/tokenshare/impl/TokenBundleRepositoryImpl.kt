 ...
 *
 * If multiple [token bundles][T] are required to be shared, specify a [key] in order to identify
 * each one, otherwise the same [default][DEFAULT_TOKEN_BUNDLE_KEY] key will be used and only a
 * single token bundle will be persisted.
 *
