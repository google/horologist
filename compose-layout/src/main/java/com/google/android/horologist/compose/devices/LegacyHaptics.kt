...
public class LegacyHaptics(private val vibrator: Vibrator) : Haptics {
    ...
    private val click = VibrationEffect.createWaveform(
        longArrayOf(150, 30),
        intArrayOf(DEFAULT_AMPLITUDE * 2, DEFAULT_AMPLITUDE * 2),
        -1
    )

    private val heavyClick = VibrationEffect.createWaveform(
        longArrayOf(150, 30),
        intArrayOf(DEFAULT_AMPLITUDE * 4, DEFAULT_AMPLITUDE * 4),
        -1
    )
