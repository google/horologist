...
constructor(
    ...
    val uiState: MutableStateFlow<DataLayerScreenState> =
        MutableStateFlow(DataLayerScreenState())
...
private fun Timestamp.isBefore(other: CounterValue): Boolean = seconds < other.updated.seconds ||
