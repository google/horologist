 ...
 * 2. The ActiveDuration delivered in an [ExerciseUpdate] will not fall on a second-boundary, so the
 *    delivery time of these messages cannot be used to determine when to update any content on the
 *    screen through a ticker.
 *
...
public fun ActiveDurationText(
   ...
   * is in the ACTIVE state, and (2) whether the component is visible. The app should handle any
   * ambient behaviour separately.
   */
 ...
 * should be returned:
 *
 * 10:23:15.2 -> returns 10:23:15.8 10:23:15.9 -> returns 10:23:16.8
 *
