...
dependencies {
    ...
    implementation(projects.networkAwareness.networkAwarenessUi)
    implementation(projects.networkAwareness.networkAwarenessOkhttp)
    implementation(projects.networkAwareness.networkAwarenessDb)
