...
class ServiceContainer(
    ...
    fun inject(service: MediaCollectionsTileService) {
        service.uampService = mediaApplicationContainer.networkModule.uampService
        service.imageLoader = mediaApplicationContainer.networkModule.imageLoader
    }

    companion object {
        internal val MediaCollectionsTileService.container: ServiceContainer
            get() = (application as MediaApplication).container.serviceContainer(this)

        fun inject(complicationService: MediaCollectionsTileService) {
