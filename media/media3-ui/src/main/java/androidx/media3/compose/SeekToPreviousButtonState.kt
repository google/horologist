    ...
    public suspend fun observe(): Nothing =
        player.listen { events ->
            if (
                ...
                _isEnabled = shouldEnableSeekToPreviousButton(this)
            }
        }

    private fun shouldEnableSeekToPreviousButton(player: Player): Boolean {
        // TODO: Actual logic for enable/disable
        return player.isCommandAvailable(Player.COMMAND_SEEK_TO_PREVIOUS_MEDIA_ITEM)
    }
}
