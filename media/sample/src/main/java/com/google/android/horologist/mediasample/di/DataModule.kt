...
class DataModule {
  ...
  fun mediaDownloadRepository(
    ...
    MediaDownloadRepositoryImpl(media3DownloadDataSource = media3DownloadDataSource)
  ...
  @Provides fun mediaExtrasMapper(): MediaExtrasMapper = MediaExtrasMapperNoopImpl
  ...
  @Provides @Dispatcher(IO) fun ioDispatcher(): CoroutineDispatcher = Dispatchers.IO
}
