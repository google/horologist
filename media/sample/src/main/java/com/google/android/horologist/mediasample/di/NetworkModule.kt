...
object NetworkModule {
  ...
  @Provides fun networkLogger(): NetworkStatusLogger = NetworkStatusLogger.Logging
  ...
  fun networkRequester(connectivityManager: ConnectivityManager): NetworkRequester =
    NetworkRequesterImpl(connectivityManager)
  ...
  @Singleton @Provides fun moshi() = Moshi.Builder().build()
  ...
  @Singleton
  @Provides
  fun uampService(retrofit: Retrofit): UampService =
    WearArtworkUampService(retrofit.create(UampService::class.java))
  ...
  fun imageLoader(
    ...
    ImageLoader.Builder(application)
      ...
      .diskCache { DiskCache.Builder().directory(cacheDir.resolve("image_cache")).build() }
