 ...
 * harshly.
 * @param startGap the gap at the start of the marquee.
...
public fun MarqueeText(
    ...
    startGap: Dp = edgeGradientWidth,
    marqueeDpPerSecond: Dp = 64.dp,
    pauseTime: Duration = 4.seconds,
) {
    val controller = remember(text, style) { MarqueeController(edgeGradientWidth, startGap) }
    controller.edgeGradientWidth = edgeGradientWidth
    controller.startGap = startGap
