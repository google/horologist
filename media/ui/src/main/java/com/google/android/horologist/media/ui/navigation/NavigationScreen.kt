...
public interface NavigationScreen {
  ...
  public data class Player(val page: Int = 0) : NavigationScreen {
    public companion object {
      public fun deepLinks(deepLinkPrefix: String): List<NavDeepLink> =
  ...
  public data object Volume : NavigationScreen {
    public fun deepLinks(deepLinkPrefix: String): List<NavDeepLink> =
      listOf(navDeepLink { uriPattern = "$deepLinkPrefix/volume" })
  }
  ...
  public data object Settings : NavigationScreen {
    public fun deepLinks(deepLinkPrefix: String): List<NavDeepLink> =
      listOf(navDeepLink { uriPattern = "$deepLinkPrefix/settings" })
  }

  @Serializable
  public data object Collections : NavigationScreen {
    public fun deepLinks(deepLinkPrefix: String): List<NavDeepLink> =
      listOf(navDeepLink { uriPattern = "$deepLinkPrefix/collections" })
  }
