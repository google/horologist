...
public class MediaCollectionsTileRenderer(
    ...
    PrimaryLayout.Builder(deviceParameters)
      ...
      .setPrimaryChipContent(
        CompactChip.Builder(
            ...
            Clickable.Builder().setOnClick(state.chipAction).build(),
            deviceParameters,
          )
  ...
  private fun spacer(size: Float) =
    Spacer.Builder().setHeight(DimensionBuilders.DpProp.Builder(size).build()).build()
