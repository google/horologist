...
class MediaPlayerA11yScreenshotTest : WearLegacyA11yTest() {
  ...
  @Config(qualifiers = "w180dp-h180dp-small-notlong-notround-watch-xhdpi-keyshidden-nonav")
  @Test
  ...
  private fun mediaPlayerScreen() {
    ...
    runScreenTest { MediaPlayerTestCase(colors = UampColors, playerUiState = playerUiState) }
  }
}
