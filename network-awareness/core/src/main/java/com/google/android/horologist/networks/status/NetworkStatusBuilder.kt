...
internal data class NetworkStatusBuilder(
  ...
  private fun readTransportType(): NetworkInfo {
    ...
    //    p2p interfaces are usually associated with peer-to-peer connections (perhaps your Android
    // device's WiFi Direct support?)
    ...
    return when {
      ...
      isTransport(NetworkCapabilities.TRANSPORT_CELLULAR) ->
