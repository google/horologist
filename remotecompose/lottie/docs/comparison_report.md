...
- **Raw Strict Schema Pass (`Animation.decodeFromString`)**: 24 / 24 (100%)
- **Post-Normalization Visual Parity (`PASS`, FG MAE < 0.06)**: 20 / 24 (83%)
- **Partial Visual Parity (`PARTIAL_PARITY`, FG MAE < 0.18)**: 2 / 24 (8%)
- **Visual Mismatch (`VISUAL_MISMATCH`)**: 0
- **Unrecoverable Parse / Render Errors**: 2
...
|---|------------|------------|------------|---------------|----------|--------|---------------|-------------------|----------------|----------------|--------------------|
| 1 | **hamburger_arrow** | `800x600` | `PASS` | `PASS` | `0.0000` | `0.0023` | `68.8` | Expressions, NullLayer, ShapeLayer, TrimPath | — | — | [View PNG](hamburger_arrow_side_by_side.png) |
| 2 | **heart** | `100x100` | `PASS` | `PASS` | `0.0064` | `0.0492` | `21.8` | Expressions, ShapeLayer, TrimPath | — | — | [View PNG](heart_side_by_side.png) |
...
| 4 | **lottielogo** | `750x1334` | `PASS` | `PASS` | `0.0076` | `0.0134` | `23.2` | Expressions, ShapeLayer, SolidLayer, TrimPath | — | — | [View PNG](lottielogo_side_by_side.png) |
...
| 6 | **CheckSwitch** | `200x200` | `PASS` | `PASS` | `0.0004` | `0.0021` | `55.5` | Expressions, ShapeLayer, TrimPath | — | — | [View PNG](CheckSwitch_side_by_side.png) |
...
| 8 | **TrimPathWrapAround** | `200x200` | `PASS` | `RENDER_ERROR` | `0.8659` | `0.8659` | `1.2` | DashStroke, Expressions, NullLayer, ShapeLayer, TrimPath | — | Cluster R2 | [View PNG](TrimPathWrapAround_side_by_side.png) |
...
| 20 | **TimeRemapAndStartOffset** | `1500x2668` | `PASS` | `RENDER_ERROR` | `0.8570` | `0.8570` | `1.2` | Assets/Precomps, Expressions, PrecompLayer, ShapeLayer | — | Cluster R2 | [View PNG](TimeRemapAndStartOffset_side_by_side.png) |
...
No schema deserialization issues detected!
## Part II: Visual Rendering Bug Clusters (Side-by-Side `rc lottie` vs `lottie-android`)
### Cluster R2: RemoteCompose Document Recording / Player Exception (2 asset(s))
- **Affected Assets**: `TrimPathWrapAround`, `TimeRemapAndStartOffset`
- **Root Cause & Diagnostics**: Exception thrown while recording or playing RemoteCompose document (Ignored pending upstream AndroidX GraphContext diamond-DAG DerivedSnapshotState fix)

### Cluster R5: Repeater Transform Order & TrimPath Wrap-Around / Multi-Shape Scope (1 asset(s))
- **Affected Assets**: `TrimPaths`
