...
internal fun Transform.bindToTimeline(animationSettings: LottieSettings): Transform =
  copy(
    ...
    rotation = StaticScalarProperty(value = animateScalar(effectiveRotation, animationSettings)),
    rz = null,
    scale =
...
internal fun transform(
  ...
  val rotation = animateScalar(transform.effectiveRotation, animationSettings)
