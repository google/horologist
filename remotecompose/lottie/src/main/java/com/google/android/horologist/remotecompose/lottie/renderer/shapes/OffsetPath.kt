      ...
      is RemoteLottiePath -> {
        ...
        val newSubpaths =
          source.path.map { subpath ->
            ...
            if (animationSettings.strictOffsetTopology) {
              subpath.requireSupportedOffsetTopology(hasCurves, amount, miterLimit)
            }
            if (!hasCurves) {
              ...
              offsetCurves(
                ...
                offsetPath.lineJoin,
                miterLimit,
                strictOffsetTopology = animationSettings.strictOffsetTopology,
              )
            }
          }
