...
class CurvedOffsetCapsTest : MotionPixelHarness() {
  ...
  @Test
  fun signedRoundCapsKeepTheirOutsideSweep() = verify(2, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun signedRoundCapsAlsoMatchFilledOutline() = verify(2, false, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun liveCurvedGeometryKeepsRoundCaps() = verify(2, true, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun signedBevelCapsCloseTheOutline() = verify(3, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun parallelMiterCapsFallBackToBevel() = verify(1, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopKeepsLiveMiterOffset() = verifyLoop(1, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopKeepsLiveBevelOffset() = verifyLoop(3, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopMiterFillMatchesAnalyticControls() = verifyLoop(1, false, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopBevelFillMatchesAnalyticControls() = verifyLoop(3, false, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopKeepsMovingControls() = verifyLoop(1, true, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopMovingFillMatchesAnalyticControls() = verifyLoop(3, true, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopKeepsSignedRoundJoin() = verifyLoop(2, false, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopRoundFillMatchesAnalyticArc() = verifyLoop(2, false, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun singleVertexLoopMovingRoundJoinMatchesAnalyticArc() = verifyLoop(2, true, false)
