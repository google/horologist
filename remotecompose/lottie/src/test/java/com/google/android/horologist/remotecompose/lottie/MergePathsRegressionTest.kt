...
class MergePathsRegressionTest : FixtureParityHarness() {
  @Ignore("TODO: Fix failure on main AST/renderer") @Test fun staticUnion() = checkMerge(2, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun staticSubtract() = checkMerge(3, false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun staticIntersection() = checkMerge(4, false)

  @Ignore("TODO: Fix failure on main AST/renderer") @Test fun staticXor() = checkMerge(5, false)

  @Ignore("TODO: Fix failure on main AST/renderer") @Test fun movingUnion() = checkMerge(2, true)

  @Ignore("TODO: Fix failure on main AST/renderer") @Test fun movingSubtract() = checkMerge(3, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun movingIntersection() = checkMerge(4, true)

  @Ignore("TODO: Fix failure on main AST/renderer") @Test fun movingXor() = checkMerge(5, true)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun staticNonZeroXorKeepsBothExcludedOverlapsEmpty() = checkXorRegions(false)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun movingNonZeroXorKeepsBothExcludedOverlapsEmpty() = checkXorRegions(true)
