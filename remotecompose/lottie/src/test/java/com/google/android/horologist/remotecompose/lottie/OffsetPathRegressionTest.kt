...
class OffsetPathRegressionTest : MotionPixelHarness() {
  ...
  @Test
  fun miterAmountStaysLiveAcrossZero() = squareMotion(1, "amount")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun roundAmountStaysLiveAcrossZero() = squareMotion(2, "amount")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun bevelAmountStaysLiveAcrossZero() = squareMotion(3, "amount")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun miterGeometryStaysLive() = squareMotion(1, "geometry")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun roundGeometryStaysLive() = squareMotion(2, "geometry")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun bevelGeometryStaysLive() = squareMotion(3, "geometry")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun miterLimitChangesTheJoinAtPlayback() = squareMotion(1, "limit")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun openMiterBuildsBothSides() = lineMotion(1)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun openRoundBuildsBothSidesAndCaps() = lineMotion(2)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun openBevelBuildsBothSides() = lineMotion(3)
