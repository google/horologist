...
class ParsingTest {
  ...
  private fun loadHeartbeatJson(): String {
    return ParsingTest::class.java.classLoader!!.getResourceAsStream("heartbeat.json")!!
      .bufferedReader()
      .readText()
  }
