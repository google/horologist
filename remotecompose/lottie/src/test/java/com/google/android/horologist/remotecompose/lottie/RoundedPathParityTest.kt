...
class RoundedPathParityTest : FixtureParityHarness() {
  ...
  @Test
  fun liveRadiusMatchesAndroid() = verify("radius")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun movingRoundedPathMatchesAndroid() = verify("geometry")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun roundedPathWithLiveTrimMatchesAndroid() = verify("trim")

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun intrinsicStarRoundnessRetainsControls() = intrinsic(1)

  @Ignore("TODO: Fix failure on main AST/renderer")
  @Test
  fun intrinsicPolygonRoundnessRetainsControls() = intrinsic(2)
