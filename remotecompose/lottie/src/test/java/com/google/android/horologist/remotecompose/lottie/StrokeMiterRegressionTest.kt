...
class StrokeMiterRegressionTest : FixtureParityHarness() {
  @Ignore("RemotePaint does not yet expose stroke miter limit")
  @Test
  fun solidLowMiterBevelsCorners() = verify(false, 0)

  @Test fun solidHighMiterRetainsCorners() = verify(false, 4)

  @Ignore("RemotePaint does not yet expose stroke miter limit")
  @Test
  fun gradientLowMiterBevelsCorners() = verify(true, 0)

  @Test fun gradientHighMiterRetainsCorners() = verify(true, 4)

  @Ignore("RemotePaint does not yet expose animated stroke miter limit")
  @Test
