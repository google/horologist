...
public data class WearDevice(
  ...
  public companion object {
    public val MobvoiTicWatchPro5: WearDevice =
      WearDevice(
        id = "ticwatch_pro_5",
    ...
    public val SamsungGalaxyWatch5: WearDevice =
      WearDevice(
        id = "galaxy_watch_5",
    ...
    public val SamsungGalaxyWatch6: WearDevice =
      WearDevice(
        id = "galaxy_watch_6",
    ...
    public val GooglePixelWatch: WearDevice =
      WearDevice(
        id = "pixel_watch",
    ...
    public val GenericSmallRound: WearDevice =
      WearDevice(
        id = "small_round",
    ...
    public val GenericLargeRound: WearDevice =
      WearDevice(
        id = "large_round",
    ...
    public val SamsungGalaxyWatch6SmallFont: WearDevice =
      SamsungGalaxyWatch6.copy(
        id = "galaxy_watch_6_small_font",
        modelName = "Samsung Galaxy Watch 6 Large",
        fontScale = 0.94f,
      )
    public val GooglePixelWatchLargeFont: WearDevice =
      GooglePixelWatch.copy(
        id = "pixel_watch_large_font",
        modelName = "Google Pixel Watch",
        fontScale = 1.24f,
      )
    public val entries: List<WearDevice> =
      listOf(
        MobvoiTicWatchPro5,
        SamsungGalaxyWatch5,
        SamsungGalaxyWatch6,
