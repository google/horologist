...
public abstract class WearLegacyComponentTest {
    ...
    public open fun testName(suffix: String): String = "src/test/snapshots/images/${this.javaClass.`package`?.name}_${this.javaClass.simpleName}_${testInfo.methodName}.png"
