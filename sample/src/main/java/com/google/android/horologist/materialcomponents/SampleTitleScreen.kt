...
@Composable
internal fun SampleTitleScreen(modifier: Modifier = Modifier, columnState: ScalingLazyColumnState) {
  ScalingLazyColumn(columnState = columnState, modifier = modifier) {
    item { Title(text = "Title") }
    item { SecondaryTitle(text = "Title") }
    item { SecondaryTitle(text = "Title", icon = Icons.Filled.Add, iconTint = Color(0xFF946EB1)) }
  }
}
