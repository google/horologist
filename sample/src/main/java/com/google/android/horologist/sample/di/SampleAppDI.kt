...
object SampleAppDI {
  @Suppress("UNUSED_PARAMETER") fun inject(mainActivity: MainActivity) {}

  @Suppress("UNUSED_PARAMETER") fun inject(auditActivity: AuditActivity) {}

  @Suppress("UNUSED_PARAMETER") fun inject(navActivity: NavActivity) {}
  ...
  fun inject(sampleApplication: SampleApplication) {
    sampleApplication.okHttpClient =
    ...
    sampleApplication.networkRepository =
      getNetworkRepository(
        context = sampleApplication,
        coroutineScope = sampleApplication.coroutineScope,
      )
    sampleApplication.networkAwareCallFactory =
      getNetworkAwareCallFactory(
        context = sampleApplication,
