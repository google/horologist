...
include(":network-awareness:network-awareness")
include(":network-awareness:network-awareness-db")
include(":network-awareness:network-awareness-okhttp")
include(":network-awareness:network-awareness-ui")
include(":datalayer")
